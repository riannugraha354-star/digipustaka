...
<style>
    ...
    .badge-status { padding: 6px 12px; border-radius: 10px; font-size: 13px; font-weight: 500; display: inline-block; min-width: 125px; text-align: center; }
    
    /* Warna Status Sesuai ENUM */
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <?php if(!empty($peminjaman)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="8" class="text-center text-muted py-5">Belum ada riwayat peminjaman.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
